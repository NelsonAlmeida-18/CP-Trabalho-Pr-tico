...
\left\{
\begin{array}{lll}
  \ensuremath{\Varid{q}\;\Varid{d}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
  \ensuremath{\Varid{r}\;\Varid{d}\comp \mathbf{in}\mathrel{=}\Varid{k}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
  \ensuremath{\Varid{c}\;\Varid{d}\comp \mathbf{in}\mathrel{=}\Varid{l}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
\end{array}

\right.
%
\just\equiv{\ensuremath{\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\mathrel{=}\cata{\conj{\Varid{h}}{\conj{\Varid{k}}{\Varid{l}}}}}}
%
...
\ensuremath{\Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\mathrel{=}\Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}

%
\just\equiv{45}
%
\ensuremath{\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\comp \mathbf{in}\mathrel{=}(\conj{\Varid{h}}{\conj{\Varid{k}}{\Varid{l}}}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}

%
\just\equiv{9}
%
\ensuremath{\conj{\Varid{q}\;\Varid{d}\comp \mathbf{in}\;}{\conj{\Varid{r}\;\Varid{d}\comp \mathbf{in}\;}{\Varid{c}\;\Varid{d}\comp \mathbf{in}\;}}\mathrel{=}(\conj{\Varid{h}}{\conj{\Varid{k}}{\Varid{l}}}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}

%
\just\equiv{20 , def in}
%

\ensuremath{\conj{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }}{\conj{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }}{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }}}\mathrel{=}(\conj{\Varid{h}}{\conj{\Varid{k}}{\Varid{l}}}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}

%
\just\equiv{9}
%
\ensuremath{\conj{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }}{\conj{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }}{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }}}\mathrel{=}}
\ensuremath{\conj{\Varid{h}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\;\conj{\Varid{k}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\;(\Varid{l}\comp \Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})}{\cdot }}{\cdot }}

%
\just\equiv{\ensuremath{\Varid{h}\mathrel{=}\alt{h_1 }{h_2 }}, \ensuremath{\Varid{k}\mathrel{=}\alt{k_1 }{k_2 }}, \ensuremath{\Varid{l}\mathrel{=}\alt{l_1 }{l_2 }} , 22}
%

\ensuremath{\conj{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }}{\conj{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }}{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }}}\mathrel{=}}
\ensuremath{\conj{\alt{h_1 \comp \Varid{id}}{h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}{\conj{\alt{k_1 \comp \Varid{id}}{k_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}{\alt{l_1 \comp \Varid{id}}{l_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}})}
...
\left\{
\begin{array}{ll}
  \ensuremath{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }\mathrel{=}\alt{h_1 \comp \Varid{id}}{h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}})}\\
  \ensuremath{\conj{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }}{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }})\mathrel{=}(\conj{\alt{k_1 \comp \Varid{id}}{k_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}{\alt{l_1 \comp \Varid{id}}{l_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}})}\\
\end{array}
...
\left\{
\begin{array}{lll}
  \ensuremath{\alt{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{q}\;\Varid{d}\;\succ }\mathrel{=}\alt{h_1 }{h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
  \ensuremath{\alt{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{r}\;\Varid{d}\;\succ }\mathrel{=}\alt{k_1 }{k_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
  \ensuremath{\alt{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}}{\Varid{c}\;\Varid{d}\;\succ }\mathrel{=}\alt{l_1 }{l_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}}\\
\end{array}
...
\left\{
\begin{array}{llllll}
  \ensuremath{\Varid{q}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}h_1 }\\
  \ensuremath{\Varid{q}\;\Varid{d}\;\succ \mathrel{=}h_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
  \ensuremath{\Varid{r}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}k_1 }\\
  \ensuremath{\Varid{r}\;\Varid{d}\;\succ \mathrel{=}(k_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})}\\
  \ensuremath{\Varid{c}\;\Varid{d}\;\underline{\mathrm{0}}\mathrel{=}l_1 }\\
  \ensuremath{\Varid{c}\;\Varid{d}\;\succ \mathrel{=}l_2 \comp \conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}\\
\end{array}
...
\ensuremath{\cata{\conj{\alt{h_1 }{h_2 }}{\conj{\alt{k_1 }{k_2 }}{\alt{l_1 }{l_2 }}}}}

%
\just\equiv{Substituição h1, k1, l1 da dedução acima}
%

\ensuremath{\cata{\conj{\alt{\underline{\mathrm{0}}}{h_2 }}{\conj{\alt{\underline{\mathrm{0}}}{k_2 }}{\alt{\underline{\Varid{d}}}{l_2 }}}}}

%
\just\equiv{Transformação em for loop conforme visto na aula teórica}
%

\ensuremath{\cata{\alt{(\underline{\mathrm{0}},(\underline{\mathrm{0}},\underline{\Varid{d}}))}{\conj{h_2 }{\conj{k_2 }{l_2 }}}}}

%
\just\equiv{}
%

\ensuremath{\for{\Varid{g}}\ {\Varid{d}}\;((\mathrm{0},(\mathrm{0},\Varid{d})))\;\mathbf{where}\;\Varid{g}\;\Varid{d}\;((\Varid{x},(\Varid{y},\Varid{z})))\mathrel{=}((h_2 ,(k_2 ,l_2 )))}
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathit B\mathbin{*}\mathit C)}
           \ar[d]^{id + both^2}
\\
     \ensuremath{\mathit B\mathbin{*}\mathit C}
&
     A + (B*C)^2
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
...
\begin{eqnarray*}
\ensuremath{\Varid{both}\mathrel{=}\cata{\Varid{g}}}

%
\just\equiv{}
%

\ensuremath{\Varid{both}\mathrel{=}\cata{\;\mathbf{in}\comp \mathit B\;(\Varid{both},\Varid{id})}}

%
\just\equiv{def in, 50}
%

\ensuremath{\Varid{both}\mathrel{=}\cata{\alt{\Conid{Leaf}}{\Conid{Fork}}\comp (\Varid{both}\mathbin{+}\Varid{id})}} 

%
\just\equiv{22,1}
%

\ensuremath{\Varid{both}\mathrel{=}\cata{\alt{\Conid{Leaf}\comp \Varid{both}}{\Conid{Fork}}}}

%
\just\equiv{45}
%

\ensuremath{\Varid{both}\comp \mathbf{in}\mathrel{=}\alt{\Conid{Leaf}\comp \Varid{both}}{\Conid{Fork}}}

O que nos dá o gene: \ensuremath{\alt{\Conid{Leaf}\comp \Varid{both}}{\Conid{Fork}}}

Transformando em point wise:

\left\{
\begin{array}{ll}
  \ensuremath{g_1 \mathrel{=}\Conid{Leaf}\;(\Varid{both}\;\Varid{x})}\\
  \ensuremath{g_2 \mathrel{=}\Conid{Fork}\;(\Varid{x},\Varid{y})}\\
\end{array}
\right .
...
Logo \ensuremath{\Varid{g}\mathrel{=}\alt{g_1 }{g_2 }}
...
\\
\>[B]{}\Varid{bob}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\Varid{umin}\;(\Varid{bob}\;(\Varid{x}),\Varid{bob}\;(\Varid{y}))\;\mathbf{where}\;\Varid{umin}\mathrel{=}\uncurry{\Varid{min}}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{LTree3}\;\Conid{A}}
           ...
           \ar@/^/[r]^-{\ensuremath{\Varid{outLTree3}}}_-\cong
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree3}\;\Conid{A}\times\mathsf{LTree3}\;\Conid{A})\times\mathsf{LTree3}\;\Conid{A}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{cataLTree3}\times\Varid{cataLTree3})\times\Varid{cataLTree3}}}
           \ar@/^/[l]^-{\ensuremath{\Varid{inLTree3}}}
\\
     \ensuremath{[\mskip1.5mu \Conid{A}\mskip1.5mu]}
&
     A + (A^* \ensuremath{\times} A^*) \ensuremath{\times} A^*
           \ar[l]^-{\ensuremath{g_1 }}
}
\end{eqnarray*}
...
\\
     \ensuremath{\Conid{Tri}\times\Conid{Int}}
           \ar[u]^-{\ensuremath{\Varid{anaLTree3}\;g_2 }}
           \ar[r]_-{\ensuremath{g_2 }}
&
     \ensuremath{\Conid{A}\mathbin{+}((\Conid{Tri}\times\Conid{Int})\times(\Conid{Tri}\times\Conid{Int}))\times(\Conid{Tri}\times\Conid{Int})}
           \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{anaLTree3}\times\Varid{anaLTree3})\times\Varid{anaLTree3}}}
}
\end{eqnarray*}
